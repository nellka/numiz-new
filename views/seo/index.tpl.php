					...
					<div class="container">
						<div class="logo-block logo-block--header">
							<div class="logo-block__logo">
								<a href="http://www.numizmatik.ru/"><img class="logo-block__img" src="<?=$tpl['seo_css_path']?>/img/logo.png" alt="Клуб Нумизмат"></a>
						...
						<div class="info info--header">
							...
							<div class="info__block info__block--phone-block">
								...
								<div class="wrap-tel-block">
									<div class="tel-block">
										<span class="tel-block__tel"><a class="tel-block__link" href="tel:+78003331477" onclick='ga("send", "event", "user", "call");_Call();'>8-800-333-14-77</a></span>
										<span class="tel-block__tel"><a class="tel-block__link" href="tel:+79030060044" onclick='ga("send", "event", "user", "call");_Call();'>+7-903-006-00-44</a></span> </div>
