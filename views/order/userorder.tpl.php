...
<div style="font-weight:400;">
		...
		<div id='user-compare-block' style="display:none;font-weight:400;">
			...
			<input type="submit"  class="button25" value='Окончательно подтвердить заказ (Обязательно нажать)' style="width:360px" onclick="$('.bg_shadow').show();">
			...
			<?} else {?>
			    Скидочный купон(ы): <br><font color="red"> <span id=coupon-result></font></span><br>
			...
			<div id='user-order-block'>
				...
				<div id='delivery-block' class="bordered_oder">
    				...
    				<div id="adress-block" style="display: none">
    					...
    					<input type=text name=postindex id='postindex' value="<?=$postindex?>" style="width: 390px;margin: 5px 0;padding: 5px;" placeholder="Индекс" onblur="calculateOrder()"><br>
    					<textarea name=adress id=adress cols=50 rows=5 style="width: 400px;"><?=$adress?></textarea>
    				</div>
                </div>
