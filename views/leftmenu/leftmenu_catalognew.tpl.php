...
<ul id='left_menu_shop' class="menu-sidebar_static">
   <li><a href='<?=$cfg['site_dir']?>catalognew' title='Каталог монет со всего мира' class="topmenu <?=($materialtype==1)?'active':''?>">Монеты</a>   </li>
   <li><a href='<?=$cfg['site_dir']?>catalognew/nabori_monet' title='Каталог наборов монет со всего мира' class="topmenu <?=($materialtype==7)?'active':''?>">Наборы монет</a></li>
  <li><a href='<?=$cfg['site_dir']?>catalognew/banknoti' title='Каталог подарочных наборов монет со всего мира' class="topmenu <?=($materialtype==2)?'active':''?>">Банкноты</a></li>
   <li><a href='<?=$cfg['site_dir']?>catalognew/podarochnye_nabory' title='Каталог подарочных наборов монет со всего мира' class="topmenu <?=($materialtype==4)?'active':''?>">Подарочные наборы</a></li>
   <li><a href='<?=$cfg['site_dir']?>catalognew/aksessuary' title='Аксессуары для нумизматов и коллекционеров' class="topmenu <?=($materialtype==3)?'active':''?>"><font color="red">New</font> Аксессуары для монет</a></li>
</ul>   
  </div>
