...
<ul id='left_menu_shop' class="menu-sidebar_static" style="display:<?=$mini?'none':'block'?>" >
   ...
   <a href='<?=$cfg['site_dir']?>shopcoins/moneti' title='Монеты стоимость(цены) весь мир' class="topmenu <?=(isset($materialtype)&&!$search&&$materialtype==1)?'active':''?>">Монеты</a>   </li>
   <li>
   ...
   <a href='<?=$cfg['site_dir']?>shopcoins/baraholka' title='Барахолка' class="topmenu <?=(isset($materialtype)&&!$search&&$materialtype==11)?'active':''?>">Барахолка</a></li>
    <li>
   ...
   <li>
   <?=($tpl['user']['user_id']==811)?"&nbsp;&nbsp;<a href='".$cfg['site_dir']."shopcoins/index.php?search=revaluation&nocheck=1' style='float:left' class='pls'><font color=black>(".(($nocheck&&$search=='revaluation')?" - ":" + ").")</font></a>":""?>
   ...
   <li><?=($tpl['user']['user_id']==811)?"&nbsp;&nbsp;<a href='".$cfg['site_dir']."shopcoins/index.php?search=newcoins&nocheck=1' style='float:left' class='pls'><font color=black>(".(($nocheck&&$search=='newcoins')?" - ":" + ").")</font></a>":""?>
