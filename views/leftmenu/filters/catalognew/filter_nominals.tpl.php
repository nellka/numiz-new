...
$nominalUrlParams['usershopcoinssubscribe'] = $urlParams['usershopcoinssubscribe'];
$nominalUrlParams['usercatalogsubscribe'] = $urlParams['usercatalogsubscribe'];
$nominalUrlParams['usermycatalog'] = $urlParams['usermycatalog'];
$nominalUrlParams['usermycatalogchange'] = $urlParams['usermycatalogchange'];
	...
	<ul class="filter_heading_ul">
		...
		foreach ($tpl['filter']['nominals']['filter'] as $filter) {
			...
			<div class="checkbox">
				   ...
				   <a href="<?=urlBuild::makePrettyUrl($nominalUrlParams,"http://www.numizmatik.ru/catalognew")?>"> <?=$filter['name'];?></a>						
			</div>
		 <?}?> 							
		</div>
	</ul>
