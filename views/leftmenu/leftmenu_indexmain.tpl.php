<div class="menu-heading" id='hidden-shopcoins-menu'><span id='hidden-shopcoins-span'><a href='<?=$cfg['site_dir']?>shopcoins/moneti' title='Монеты стоимость(цены) весь мир' class="white mw">Магазин монет</a></span></div>
<ul class="menu-sidebar top" id="left_menu_full">
<li><a href='<?=$cfg['site_dir']?>shopcoins/moneti' title='Монеты стоимость(цены) весь мир' class=topmenu>Монеты</a></li>
...
<li><a href='<?=$cfg['site_dir']?>shopcoins/newcoins' title='Новинки 2013-2015' class=topmenu>Новинки 2014-<?=date('Y',time())?></a></li>
...
<div class="menu-heading" id='hidden-shopcoins-menu' onclick="showMainLeftMenu('left_menu_cat')"><span id='hidden-shopcoins-span'>Каталог монет</span></div>
...
<div class="menu-heading" id='hidden-shopcoins-menu'  onclick="showMainLeftMenu('left_menu_news')"><span id='hidden-shopcoins-span'>Нумизмату</span></div>
...
<div class="menu-heading" id='hidden-shopcoins-menu' onclick="showMainLeftMenu('left_menu_auction')"><span id='hidden-shopcoins-span'>Аукцион монет</span></div>
...
<div class="menu-heading" id='hidden-shopcoins-menu' onclick="showMainLeftMenu('left_menu_journal')"><span id='hidden-shopcoins-span'>Газеты и журналы</span></div>
...
<div class="menu-heading" id='hidden-shopcoins-menu' onclick="showMainLeftMenu('left_menu_serv')"><span id='hidden-shopcoins-span'>Сервисы</span></div>
...
<div class="menu-heading" id='hidden-shopcoins-menu' onclick="showMainLeftMenu('left_menu_link')"><span id='hidden-shopcoins-span'>Обратная связь</span></div>
...
<script> 
 ...
 $('#hidden-shopcoins-menu').click(function (e) {
     if ($(e.target).prop('id') == "hidden-shopcoins-menu") {
