<div class="menu-heading" id='hidden-shopcoins-menu'><span id='hidden-shopcoins-span'>Разделы сайта</span></div>
<ul class="menu-sidebar" id="left_menu_full">
   <li> <a href="<?=$cfg['site_dir']?>shopcoins/" class="<?=('/'==$tpl['current_page'])?'active':''?>"><span>Магазин монет</span></a>
        ...
        <ul>
            ...
            <li><a href='<?=$cfg['site_dir']?>shopcoins/cvetnie_moneti' title='Цветные монеты' class="topmenu">Цветные монеты </a></li>
            ...
            <li><a href='<?=$cfg['site_dir']?>shopcoins/newcoins' title='Новинки монет 2014-2016' class=topmenu>Новинки монет 2014-2016</a></li>
