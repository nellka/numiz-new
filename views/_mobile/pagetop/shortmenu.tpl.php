...
<ul id='left_menu_shop' class="menu-sidebar_static" style="display:'none'" >
   ...
   <a href='<?=$cfg['site_dir']?>shopcoins/baraholka' title='Барахолка' >Барахолка</a></li>
    ...
    <a href='<?=$cfg['site_dir']?>shopcoins/loty_dlya_nachinayushchih' title='Лоты монет для начинающих'>Лоты монет для начинающих</a></li>
   <li>
   ...
   <a href='<?=$cfg['site_dir']?>shopcoins/index.php?search=newcoins' title='Новинки монет <?=(date('Y',time())-2)?>-<?=date('Y',time())?>' class="topmenu <?=(isset($search)&&$search=='newcoins')?'active':''?>">Новинки монет <?=(date('Y',time())-2)?>-<?=date('Y',time())?></a></li>
