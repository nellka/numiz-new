...
$mail_text .= '<tr><td style="border:1px solid #cccccc;padding:10px;">Номер</td><td  style="border:1px solid #cccccc;padding:10px;">Наименование</td><td  style="border:1px solid #cccccc;padding:10px;">Цена</td><td  style="border:1px solid #cccccc;padding:10px;">Количество</td><td style="border:1px solid #cccccc;padding:10px;" >Сумма</td></tr>' ;
foreach ( $tpl['submitorder']['result'] as $rows){
	if ($rows['title_materialtype']){
		$mail_text .= '<td colspan="5" style="border:1px solid #cccccc; background-color:#eeeeee;padding:10px;font-size:14px;font-weight:bold;">'.$MaterialTypeArray[$rows["materialtype"]].'</td></tr>';
	}
	$mail_text .= '<tr>';
