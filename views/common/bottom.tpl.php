...
<div id='footer' class="wraper" itemscope itemtype="http://schema.org/WPFooter">
<div id='footer-menu'>
    <div class="col-5" itemscope itemtype="http://schema.org/SiteNavigationElement">
        <div class="m-header">Магазин монет</div>
    ...
    <div class="col-5">
        <div class="m-header">Каталог монет</div>
    ...
    <div class="col-5">
        <div class="m-header">Нумизмату</div>
        <a title="Последние новости нумизматики" href="http://numizmatik.ru/news/">Новости нумизматики</a><br>
    ...
    <div class="col-5">
        ...
        <a title="Для прессы" href="http://www.numizmatik.ru/press/">Для прессы</a><br>
        <a title="Контакты" href="http://www.numizmatik.ru/shopinfo.php">Контакты</a>
       </div>
      <div class="col-5 send-error">
       <div class="m-header">Нашли ошибку?</div>
...
<br><a href="mailto:administrator@numizmatik.ru">administrator@numizmatik.ru</a>
