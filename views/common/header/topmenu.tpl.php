<div id="cssmenu" class="wraper">
    <ul id="ddmenu">  
       ...
       <div id="menu3"  class="submenu">   
            ...
            <li><a href='http://www.numizmatik.ru/shopcoins/newcoins' onmouseover="showMenuDescription('newcoins');" title='Новинки <?=(date('Y',time())-1)?>-<?=date('Y',time())?>' class=topmenu>Новинки <?=(date('Y',time())-1)?>-<?=date('Y',time())?></a></li>
            ...
            <li><a href='http://www.numizmatik.ru/shopcoins/revaluation' onmouseover="showMenuDescription('revaluation');" title='Распродажа монет' class=topmenu>Распродажа монет</a></li>    
