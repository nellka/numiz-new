...
<div id="header" class="wraper header" style="display:<?=$mini?'none':'block'?>;<?=($tpl['mv'])?'padding: 0':""?>" itemscope itemtype="http://schema.org/WPHeader">
    <?php include $cfg['path'] . '/views/common/header/top.tpl.php'; ?>
</div> 
<div id="header-mini" class="wraper header-mini" style="display:<?=$mini?'block':'none'?>; <?=($tpl['mv'])?"padding: 0":""?>" itemscope itemtype="http://schema.org/WPHeader">
