<div class="wraper clearfix showitem" itemscope itemtype="http://schema.org/Product">  
<?
		...
		<div id=allreviews style="vertical-align:top;width:400px;overflow:hidden;height:500px;">
			...
			<? if (sizeof($tpl['show']['reviews']['reviewusers'])) {
				...
				<div itemscope itemtype="http://schema.org/Review">
				   ...
				   <div itemprop="description" id='review<?=(isset($value["catalog"])&&$value["catalog"])?$value["catalog"]:$value["shopcoins"]?>'>			   
					   <?=$value['review']?>
				   </div>
					<div style="text-align:right;margin-bottom:15px;">
						<span style="color:#cccccc;">Добавлено: </span><b><span itemprop="datePublished"> <?=date('d-m-Y',$value['dateinsert'])?></span></b>
					</div>
				</div>
			<?}
			} else {
		...
		<div class="wraper clearfix" style="height:270px;padding-top:15px;">
			...
			foreach ($tpl['shop']['resultp']  as $rowsp ){
				...
				if(isset($rowsp["shopcoins"])){?>
					...
					<div id=imagem<?=$kn?>  class="coin_info" style="margin-left:8px;margin-right:8px;" itemscope itemtype="http://schema.org/Product">
